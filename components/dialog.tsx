      ...
      <DialogPrimitive.Content
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background focus:ring-ring absolute top-4 right-4 rounded-xl opacity-60 hover:opacity-100 hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-300 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none p-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 z-20">
            <XIcon />
